...
#import "Constant.h"
#import "KN_User.h"
@interface ConsumerChangePasswordVC ()

@end

@implementation ConsumerChangePasswordVC
...
-(void)callChangePassword
{
    ...
    NSDictionary *dictUserInfo = [[[NSUserDefaults standardUserDefaults]valueForKey:@"loginUser"]mutableCopy];
