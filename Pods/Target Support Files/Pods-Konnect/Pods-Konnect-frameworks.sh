...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/GJPG/GJPG/GJPGLX.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GJPG/GJPG.framework"
  ...
  install_framework "${PODS_ROOT}/PushSpring/PushSpring.framework"
